...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    title: "Accounting",
    items: [
      { title: "Journal Entries", href: "/dashboard/journal", icon: BookOpen },
      { title: "Chart of Accounts", href: "/dashboard/accounts", icon: Scale },
      { title: "Trial Balance", href: "/dashboard/trial-balance", icon: Calculator },
      { title: "Aged Receivables", href: "/dashboard/receivables", icon: Receipt },
    ],
  },
  {
    title: "Reports",
    items: [
      { title: "P&L Statement", href: "/dashboard/pl", icon: TrendingUp },
      { title: "Balance Sheet", href: "/dashboard/balance", icon: FileText },
      { title: "Cash Flow", href: "/dashboard/cashflow", icon: PoundSterling },
      { title: "Tax Reports", href: "/dashboard/tax", icon: Bell, badge: "VAT" },
    ],
  },
  {
    title: "System",
        ...
        <div className={cn("flex items-center", collapsed ? "justify-center" : "gap-2 px-1")}>
          {!collapsed && (
            <div className="flex-1 min-w-0">
              <p className="truncate text-xs font-medium text-sidebar-foreground">Sarah Smith</p>
              <p className="truncate text-[10px] text-muted-foreground">Certified Bookkeeper</p>
            </div>
          )}
